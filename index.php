...
<body>
    <header class="header">
        <nav class="nav">
            ...
            <div class="end">
                <ul class="nav__links">
                    <li class="nav__item">
                        <a class="nav__link nav__link--btn btn--show-login-modal" href="src/loginpage.php">Login</a>
                    </li>
                    <li class="nav__item">
                        <a class="nav__link nav__link--btn btn--show-account-modal" href="src/adminlogin.php">Admin
                        </a>
                    </li>
                    <li class="nav__item">
                        <a class="nav__link nav__link--btn btn--show-account-modal" href="src/openAcc.php">Open
                            Account</a>
                    </li>
    ...
    <section class="section" id="section--1">
        ...
        <div class="features">
            ...
            <img src="img/card1.jpg" data-src="img/card1.jpg" alt="Credit card" class="features__img lazy-img" />
            <div class="features__feature">
                <div class="features__icon">
                    <svg>
    ...
    <section class="section" id="section--3">
        <div class="section__title section__title--testimonials">
            ...
            <h3 class="section__header">
                Millions of customers are already making their lifes simpler.
            </h3>
        </div>
    ...
    <section class="section section--sign-up">
        <div class="section__title">
            <h3 class="section__header">
                The best day to join Connectpay was one year ago. The second best is
                today!
            </h3>
        </div>
        <button class="btn btn--show-modal" onClick="document.location.href='src/openAcc.php'">Open your free account
            today!</button>
    </section>
    ...
    <footer class="footer">
        ...
        <img src="img/logo1.jpg" alt="Logo" class="footer__logo" />
